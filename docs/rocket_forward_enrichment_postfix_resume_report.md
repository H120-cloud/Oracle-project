...
| Durable cache hits | 25 |
| Checkpoint resume skips | 25 |
| Failed groups | 0 |
...
- Smoke API calls per group: **0.00**.
- Estimated total API calls at the observed rate: **0**.
- Polygon-only free-tier lower-bound runtime at 5 requests/minute: **0.0 hours**.
